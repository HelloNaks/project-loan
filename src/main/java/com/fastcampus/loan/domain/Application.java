...
public class Application extends BaseEntity {
    ...
    @Column(columnDefinition = "decimal(3,4) DEFAULT NULL COMMENT '금리'")
    private BigDecimal interestRate;

    @Column(columnDefinition = "decimal(3,4) DEFAULT NULL COMMENT '취급수수료'")
    private BigDecimal fee;

    @Column(columnDefinition = "datetime DEFAULT NULL COMMENT '만기 일자'")
    private LocalDateTime maturity;

    @Column(columnDefinition = "decimal(13, 2) DEFAULT NULL COMMENT '대출 신청 금액'")
